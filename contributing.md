# Contributing to prompt-history

First and foremost, thank you! We appreciate that you want to contribute to prompt-history, your time is valuable, and your contributions mean a lot to us.
...
**Showing support for prompt-history**

Please keep in mind that open source software is built by people like you, who spend their free time creating things the rest the community can use.

Don't have time to contribute? No worries, here are some other ways to show your support for prompt-history:

- star the [project](https://github.com/enquirer/prompt-history)
- tweet your support for prompt-history
...
- **version**: please note the version of prompt-history are you using
...
[so]: http://stackoverflow.com/questions/tagged/prompt-history